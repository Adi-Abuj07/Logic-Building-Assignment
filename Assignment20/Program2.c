...
int Check(int Arr[], int iSize, int iSearch)
{
    int iCnt = 0;
...
Enter the 2 element:46
Enter the 3 element:76
Enter the 4 element:23
Enter the 5 element:75

Enter the element you searching for:46
